	...
	public $validate = array(
		'username' => array(
			...
			'username_min' => array(
				...
				'message' => 'Хэрэглэгчийн нэр доод тал нь 3 үсэгтэй шаардлагатай')),
		'email' => array(
			'isValid' => array(
				'rule' => 'email',
				'required' => true,
			...
			'isUnique' => array(
				...
				'message' => 'Энэ имэйл ашиглагдаж байна')),
		'password' => array(
			'too_short' => array(
				'rule' => array('minLength', '6'),
				'message' => 'Нууц үг доод тал нь 6 үсэг шаардлагатай'),
			'required' => array(
				'rule' => 'notEmpty',
				'message' => 'Нууц үгээ оруулна уу')),
		'temppassword' => array(
			'rule' => 'confirmPassword',
			'message' => 'Нууц үгнүүд таарахгүй байна. Дахин оролдоно уу'),
		'tos' => array(
			'rule' => array('custom','[1]'),
			'message' => 'Та хэрэглээний нөхцлийг зөвшөөрөх ёстой'));
		// 'username' => array(
		// 	'required' => array(
		// 		'rule' => array('notEmpty'),
		// 		'required' => true, 'allowEmpty' => false,
